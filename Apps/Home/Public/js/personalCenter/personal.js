define(['jquery', 'bootstrap', 'validate', 'loadlist', 'mygoodlist', 'ajaxfileupload', 'message', 'json2', 'scrollto', 'comfn'], function($, b, validate, loadlist, mygoodlist, ajaxfileupload, Message, json2, scrollto, comfn) {
